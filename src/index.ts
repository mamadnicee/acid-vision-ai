...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    try {
      ...
      if (modelKey === "dev") {
        // SDXL Lightning — available on free tier, supports aspect ratio + negative prompt
      ...
      console.log("Is Response:", response instanceof Response);
      ...
      // strip data:image prefix if present (some models include it)
